...
import {updateSeason, updateEpisode, updateMessage, saveView} from '../episodeSlice'
...
const MainPage = () => {
  ...
  return (
    ...
    <Form className="submitWatchProgess" onSubmit = {e=>{
      console.log('episodestate',episode)
      e.preventDefault();
      saveView(e.target.value)} }style={{display: "flex", flexDirection: "column", justifyContent: "center"} } >
   ...
   <div style={{display: "flex", justifyContent: "space-around", marginBottom: "20px", marginTop: "20px"}}>
      <Form.Group className="seasonInput" controlId="seasonInput" style={{display: "flex", flexDirection: "column"}}>
        ...
        <Form.Control type="text" value = {episode.season} onChange = {(e)=>dispatch(updateSeason(e.target.value))}/>
        </Form.Group>
     <Form.Group className="episodeInput" controlId="episodeInput" style={{display: "flex", flexDirection: "column"}}>
        ...
        <Form.Control type="text" value = {episode.episode} onChange = {(e)=>dispatch(updateEpisode(e.target.value))}/>
     </Form.Group> 
    </div>
    <div style={{display: "flex", justifyContent: "space-around", marginBottom: "20px"}}>
        <Form.Group className="commentInput" controlId="commentInput" style={{display: "flex", flexDirection: "column", width: "90%"}}>
          ...
          <Form.Control as="textarea" value = {episode.message} rows={3} onChange = {(e)=>dispatch(updateMessage(e.target.value))}/>
        </Form.Group>
    </div> 
